  ...
  return (
            ...
            <div className="bg-gray-100 flex justify-center items-center h-screen">
                <div className="w-7/12 h-screen hidden lg:block">
                    <img src="https://u-static.fotor.com/images/text-to-image/result/PRO-6d306016caf3405cb76d12ff23b9c41a.jpg" alt="Placeholder Image" className="object-cover w-full h-full"/>
                </div>
